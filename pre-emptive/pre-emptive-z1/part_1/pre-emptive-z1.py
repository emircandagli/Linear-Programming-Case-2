...
"""pre-emptive goal programming z1 and z2 order"""

model.vOD = pyo.Var(bounds = (0.0, None), doc = 'Positive deviation for objective 1')
...
def eDeviation(model):
    return model.vTotal_Cost <= 32000000 + model.vOD
